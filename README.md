...
```
also if you have tsconfig.json, you probably should change "noImplicitThis" to false to kill the "this implicity" error. (If you setup .d.ts file, you don't have to change this)
```
